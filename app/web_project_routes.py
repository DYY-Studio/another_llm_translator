...
def register_project_routes(*, app: FastAPI, projects_root: Path, app_root: Path, project: Callable[[str], Path], project_paths: Callable[[], list[Path]], remember_project: Callable[[Path], None]) -> None:
