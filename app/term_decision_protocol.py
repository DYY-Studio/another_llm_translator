...
_PROTOCOL = {
    "zh-CN": (
        ...
        "JSON null；aliases 为字符串数组。description 只能保持当前值或清为 null。aliases 只能"
        "使用本次 terms[]/anchors[] 中可见的 source/alias 原文，不得虚构或重复。group_primary "
    ...
    "en": (
        ...
        "string array. description may only retain its current value or become null. aliases may use "
