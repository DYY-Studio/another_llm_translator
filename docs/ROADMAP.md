...
- 本地 Web Alpha 已覆盖项目、术语、结果审校、阶段决策、apply 和 export，并
  保持回环地址和单写任务安全边界。
- 产品路线 Stage 1 至 Stage 8、Stage 10 已完成；下一阶段是项目创建与输入
  队列。
